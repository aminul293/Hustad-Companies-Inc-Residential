...
CODE = r"""import jsPDF from "jspdf";
...
function renderStats(d: jsPDF, pt: PathType, photosCount: number) {
  let stats = [];
  if (pt === "urgent_repair") {
    stats = [
...
function renderFindings(d: jsPDF, pt: PathType) {
...
// MAIN GENERATOR
// ─────────────────────────────────────────────────────────────────────────────
export async function generateReportPDF(s: SessionState, photos: any, logo: any, rid: any, ptType: any) {
