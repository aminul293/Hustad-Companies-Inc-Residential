  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 overflow-hidden px-4">
        ...
        {/* Client Logos */}
        <section id="clients" className="w-full py-12 md:py-16 lg:py-20 px-4">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
              ...
              {[...Array(6)].map((_, i) => (
                ...
                >
                  <div className="rounded-3xl border p-6 bg-background/80 hover:shadow-md transition-all">
                    <div className="w-[160px] h-[80px] relative flex items-center justify-center overflow-hidden rounded-xl bg-muted/30">
                       <Palette className="w-10 h-10 text-muted-foreground/30" />
                       <span className="absolute bottom-2 text-[10px] font-mono text-muted-foreground/40 uppercase">Partner {i+1}</span>
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        {/* Services Section */}
        <section id="services" className="w-full py-12 md:py-24 lg:py-32 px-4">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
        ...
        <section id="work" className="w-full py-12 md:py-24 lg:py-32 px-4">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          ...
          >
            ...
            >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100 z-10"></div>
                <Image
                  src="https://images.unsplash.com/photo-1586717791821-3f44a563cc4c?q=80&w=2070&auto=format&fit=crop"
        ...
        <section id="about" className="w-full py-12 md:py-24 lg:py-32 px-4">
          ...
          >
            ...
            <div className="mt-16 px-6 pb-10">
              ...
              >
                {[
                  { name: "Alex Johnson", role: "Creative Director", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=300&h=400&auto=format&fit=crop" },
                  { name: "Sam Taylor", role: "Lead Designer", img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=300&h=400&auto=format&fit=crop" },
                  { name: "Jordan Smith", role: "Senior Developer", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=300&h=400&auto=format&fit=crop" },
                  { name: "Casey Brown", role: "Project Manager", img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=300&h=400&auto=format&fit=crop" },
                ].map((member, index) => (
                  <motion.div
                    key={index}
                    variants={itemFadeIn}
