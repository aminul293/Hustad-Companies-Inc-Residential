...
export default function RemoteReviewPage() {
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto bg-[#060606] text-[#E8EDF8] font-sans selection:bg-indigo-500/30 custom-scrollbar pb-32" style={{ WebkitOverflowScrolling: 'touch' }}>
